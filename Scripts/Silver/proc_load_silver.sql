...
BEGIN
	...
	BEGIN TRY
        ...
        SET @start_time= GETDATE();
        PRINT '>> Truncating Table: silver_crm_sale_details ';
        TRUNCATE TABLE silver_crm_sale_details;
        PRINT '>> Inserting Data Into: silver_crm_sale_details';
        INSERT INTO silver_crm_sale_details(
            sls_ord_num,
            sls_prd_key,
            sls_cust_id,
            sls_order_dt, 
